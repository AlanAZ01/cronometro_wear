...
class _TimerScreenState extends State<TimerScreen> {
  ...
  void _handleStartStop() {
    if (_status == "Start") {
      _startTimer();
      setState(() {
        _status = "Stop"; // Cambiamos a "Stop" al iniciar el cronómetro
      });
    } else if (_status == "Stop") {
      _timer.cancel();
      setState(() {
        _status = "Continue"; // Cambiamos a "Continue" al pausar el cronómetro
      });
    } else if (_status == "Continue") {
      _startTimer();
      setState(() {
        _status = "Stop"; // Cambiamos a "Stop" al continuar el cronómetro
      });
    }
  }
  ...
  void _handleReset() {
    ...
    setState(() {
      _count = 0;
      _strCount = "00:00";
      _status = "Start"; // Reiniciamos a "Start" al presionar Reset
    });
  }
